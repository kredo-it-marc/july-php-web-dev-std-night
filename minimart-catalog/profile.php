    ...
    <div class="container py-5">
        <?php
            if( isset($_POST["btn_upload"]) )
            {
                ...
                //PROCESS
                updateProfilePhoto($_SESSION["user_id"], $filename, $tmp_name);
            }
        ?>
...
<?php
    ...
    function updateProfilePhoto($user_id, $filename, $tmp_name)
    {
        $conn = dbConnect();
        ...
        if($conn->query($sql))
        {
            //move the file from the temporary location to the permanent storage
        ...
        else
        {
            ...
            echo "<div class='alert alert-danger w-50 mx-auto mb-4 text-center'>Failed to upload photo. Kindly try again. <br><small>".$conn->error."</small></div>";        
        }
    }
